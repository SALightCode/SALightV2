...
export default function Impressum() {
  return (
    <PageShell>
      <section className="page-hero section-shell legal-hero">
        <p className="eyebrow">Impressum</p>
        <h1>Impressum & rechtliche Hinweise</h1>
        <p>
          Angaben gemäß § 5 DDG. Bitte die Pflichtangaben vor Veröffentlichung
          rechtlich prüfen lassen.
        </p>

        <div className="imprint-image-box glass">
          <p className="small-label">Betreiberangaben</p>
          <img src="/images/impressum-daten.png" alt="Impressumsdaten SALight" />
          <p className="muted-note">
            Lege deine Bilddatei mit den Impressumsdaten unter
            <code> public/images/impressum-daten.png </code> ab.
          </p>
        </div>
      </section>
      ...
      <section className="section-shell legal-content">
        ...
        <p>
          Wir weisen darauf hin, dass die Datenübertragung im Internet, zum Beispiel bei der
